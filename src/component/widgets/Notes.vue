        ...
        <el-main class="noPadding" style="height: 300px">
            ...
            >
                ...
                >
                    ...
                    <p class="notesText scrollbar-div"
                       style="
              padding-right: 10px;
              max-width: 93%;
              max-height: 250px;
    ...
    methods: {
        ...
        async del(notesName: string) {
            ElMessageBox.confirm("确认删除吗?", "提示", {}).then(async () => {
                let i = Objects.requireNonNull(this.notesGetIndex(notesName));
        ...
        async revertConfirm(updateTime: string, detail: Array<Notes>) {
            ElMessageBox.confirm("确认使用时间机器恢复至[" + updateTime + "]的版本吗?", "提示", {}).then(async () => {
